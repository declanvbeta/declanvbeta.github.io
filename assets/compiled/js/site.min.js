...
var imageOptimizer=function(o,i){void 0!==typeof o&&null!==o||(o=".grid");var e,n,t,r,a=document.querySelector(o),s=[].slice.call(a.querySelectorAll("img.lazy")),c=function(){config={rootMargin:"250px 0px"};var r=new IntersectionObserver(function(e,n){e.forEach(function(e){if(e.isIntersecting&&0<e.intersectionRatio){var n=e.target,t=new Image;t.onload=function(){n.src=this.src,$lazyImage=$(n),$lazyImage.removeClass("blur"),n.classList.add("unblur"),null!==i&&void 0!==typeof i&&$(o).masonry("layout")},t.src=n.dataset.src,r.unobserve(n)}})},config);s.forEach(function(e){r.observe(e)})};if("IntersectionObserver"in window)c();else{e="/assets/compiled/js/intersectionObserverPolyfill.js",n=c,t=document.head,(r=document.createElement("script")).type="text/javascript",r.src=e,r.onreadystatechange=n,r.onload=n,t.appendChild(r)}};
