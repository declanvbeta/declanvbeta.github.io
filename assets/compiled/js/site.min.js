...
var imageOptimizer=function(o,a){void 0!==typeof o&&null!==o||(o=".grid");var e=document.querySelector(o),r=[].slice.call(e.querySelectorAll("img.lazy"));if("IntersectionObserver"in window){config={rootMargin:"250px 0px"};var t=new IntersectionObserver(function(e,r){e.forEach(function(e){if(e.isIntersecting&&0<e.intersectionRatio){var r=e.target,n=new Image;n.onload=function(){r.src=this.src,$lazyImage=$(r),$lazyImage.removeClass("blur"),r.classList.add("unblur"),null!==a&&void 0!==typeof a&&$(o).masonry("layout")},n.src=r.dataset.src,t.unobserve(r)}})},config);r.forEach(function(e){t.observe(e)})}else r.forEach(function(e){e.src=e.dataset.src,$lazyImage.removeClass("blur")})};
