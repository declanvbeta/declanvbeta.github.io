...
var imageOptimizer=function(r,a){void 0!==typeof r&&null!==r||(r=".grid");var e,t,n,o,i=document.querySelector(r),c=[].slice.call(i.querySelectorAll("img.lazy")),s=function(){config={rootMargin:"250px 0px"};var o=new IntersectionObserver(function(e,t){e.forEach(function(e){if(e.isIntersecting&&0<e.intersectionRatio){var t=e.target,n=new Image;n.onload=function(){t.src=this.src,$lazyImage=$(t),$lazyImage.removeClass("blur"),t.classList.add("unblur"),console.log("here is the image: ",t),null!==a&&void 0!==typeof a&&$(r).masonry("layout")},n.src=t.dataset.src,o.unobserve(t)}})},config);c.forEach(function(e){o.observe(e)})};e="/assets/compiled/js/intersectionObserverPolyfill.js",t=s,n=document.head,(o=document.createElement("script")).type="text/javascript",o.src=e,o.onreadystatechange=t,o.onload=t,n.appendChild(o)};
